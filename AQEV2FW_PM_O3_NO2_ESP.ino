...
void initializeHardware(void) {
    ...
    Serial.println(F(" |     NO2 / O3 / PM Sensor Suite     |"));
...
void restore(char * arg) {
    ...
    if (strncmp(arg, "defaults", 8) == 0) {
        ...
        eeprom_write_block("aqev2_pm_o3_no2_esp", (void *) EEPROM_UPDATE_FILENAME, 32);
    }
...
boolean publishHeartbeat() {
    ...
    snprintf(scratch, SCRATCH_BUFFER_SIZE-1,
             ...
             "\"converted-value\":%d,"
             "\"firmware-version\":\"%s\","
             "\"publishes\":[\"particulate\",\"o3\",\"no2\",\"temperature\",\"humidity\"%s],"
             "\"counter\":%lu"
